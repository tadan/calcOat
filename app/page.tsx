          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mb-8 font-mono">
                Calculate the environmental impact of switching from dairy to
                plant-based alternatives. See how much carbon, water, and land
                you can save.
              </p>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="border-5 border-white bg-white p-6 text-black">
                <div className="mb-2 text-4xl font-bold">2.5kg</div>
                <div className="font-mono text-sm uppercase">
                  CO₂ saved per liter
                </div>
              </div>
              <div className="border-5 border-white bg-white p-6 text-black">
                <div className="mb-2 text-4xl font-bold">600L</div>
                <div className="font-mono text-sm uppercase">
                  Water saved per liter
                </div>
              </div>
              <div className="border-5 border-white bg-white p-6 text-black">
                <div className="mb-2 text-4xl font-bold">8m²</div>
                <div className="font-mono text-sm uppercase">
        ...
        <Container>
          <div className="mb-12 text-center">
            ...
            <p className="font-mono text-lg">
              Compare the environmental impact of our products vs. dairy
            </p>
          </div>
          ...
          {products.length > 0 ? (
            ...
            <div className="border-5 border-black bg-oatly-cream p-12 text-center">
              ...
              <p className="font-mono">
                Products will appear here once they&apos;re published in
                Storyblok.
              </p>
            </div>
          )}
